...
<img src="https://raw.githubusercontent.com/Prog-Jacob/watermarking-eeg-models/refs/heads/main/show_stats_output.png" alt="Left: Example output of the show_stats experiment showing dataset and results summaries. Top Right: The effect of true/null watermark embedding on the input EEG data for the EEGNet model. Middle Right: The importance analysis of the EEG electrodes for the CCNN model. Bottom Right: Summary of the co-existence among emotion pairs in the DEAP dataset." width="100%">
